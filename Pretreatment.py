...
class App(tk.Tk):
    def __init__(self):
        ...
        noteList = ["Re", "Do", "Si", "La", "So", "Fa", "Mi", "Re", "Do",
                    "Si", "La", "So", "Fa", "Mi", "Re", "Do", "Si", "La", "So"]
        ...
        accidental_labels = ['##', '#', '', 'b', 'bb', '♮']
        accidental_values = [2, 1, 0, -1, -2, -3]
        for i, value in enumerate(accidental_values):
            button = tk.Radiobutton(
                self,
